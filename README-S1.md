...
### What changed between Sprint 0 and Sprint 1.
#### Pre-EDA:
- The disease dataset was close to 200,000 fields
- The demographics tables were split into 3 CSVs --> 2001-2010, 2010-2019, and 2019-2022
- Resolving table size mismatch and renaming columns.
...
#### Post-EDA
- All tables merged into one concise CSV but now the data has been reduced to 63,000 total fields. Keep in mind the datatypes listed below are dynamic and may change throughout the process. Certain columns may even be grouped together or dropped depending on feedback/overall impact.
- There are no duplicates or null values.
- Data is clean and ready for experimentation. 
### Merged table
| Column Name                         | Data Type |
|-------------------------------------|-----------|
| Disease                             | Object    |
